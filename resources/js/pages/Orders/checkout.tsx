...
export default function checkout() {
    const handelform = () => {        // Handle form submission logic here
        route('thankyou');
    };
    return (
        <>
                            ...
                            <div className="lg:col-span-8">
                                <div className="p-6 rounded-md shadow-sm dark:shadow-gray-800">
                                        ...
                                        <div className="grid lg:grid-cols-12 grid-cols-1 mt-6 gap-5">
                                            ...
                                            <div className="lg:col-span-6">
                                                ...
                                                <div className="relative mt-2">
                                                    <span className="absolute top-0.5 start-0.5 w-9 h-9 text-xl bg-gray-100 dark:bg-slate-800 inline-flex justify-center items-center text-slate-900 dark:text-white rounded" id="basic-addon1"><i className="mdi mdi-at"></i></span>
                                    ...
                                    <form>
                                        <div className="grid lg:grid-cols-12 grid-cols-1 mt-6 gap-5">
                                            <div className="lg:col-span-12">
                                                <div className="block">
                                                    <div>
                                                        <label className="inline-flex items-center">
                                                            <input type="radio" className="form-radio border-gray-100 dark:border-gray-800 text-orange-500 focus:border-orange-300 focus:ring focus:ring-offset-0 focus:ring-orange-200 focus:ring-opacity-50 me-2" name="radio-colors" value="1" checked />
                                                ...
                                                <div className="block mt-2">
                                                    <div>
                                                        <label className="inline-flex items-center">
                                                            <input type="radio" className="form-radio border-gray-100 dark:border-gray-800 text-orange-500 focus:border-orange-300 focus:ring focus:ring-offset-0 focus:ring-orange-200 focus:ring-opacity-50 me-2" name="radio-colors" value="1" />
                                        ...
                                        <div className="mt-4">
                                        <input type="submit" onClick={handelform} className="py-2 px-5 inline-block tracking-wide align-middle duration-500 text-base text-center bg-orange-500 text-white rounded-md w-full" value="Continue to checkout" />
                                    </div>
                                    </form>
                                </div>
                            ...
                            <div className="lg:col-span-4">
                                <div className="p-6 rounded-md shadow-sm dark:shadow-gray-800">
                                    <div className="flex justify-between items-center">
                                        ...
                                        <a href="javascript:void(0)" className="bg-orange-500 flex justify-center items-center text-white text-[10px] font-bold px-2.5 py-0.5 rounded-full h-5">3</a>
                                    </div>
