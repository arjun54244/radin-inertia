                                ...
                                <div className="p-6 rounded-md shadow-sm dark:shadow-gray-800 bg-white dark:bg-slate-900">
                                    <div className="border-b border-gray-100 dark:border-gray-700 pb-6">
                                        <div className="md:flex justify-between">
                                            <div>
                                                <img src="assets/images/logo-dark.png" className="block dark:hidden" alt="" />
                                                <img src="assets/images/logo-light.png" className="hidden dark:block" alt="" />
                                                <div className="flex mt-4">
                                                    <i data-feather="link" className="h-4 w-4 me-3 mt-1"></i>
                                                    <a href="#" className="text-orange-500 dark:text-white font-medium">www.radianbooks.in</a>
                                                </div>
                                            </div>
                                            ...
                                            <div className="mt-6 md:mt-0 md:w-56">
                                                ...
                                                <ul className="list-none">
                                                    <li className="flex mt-3">
                                                        <i data-feather="map-pin" className="h-4 w-4 me-3 mt-1"></i>
                                                        <a href="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d39206.002432144705!2d-95.4973981212445!3d29.709510002925988!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8640c16de81f3ca5%3A0xf43e0b60ae539ac9!2sGerald+D.+Hines+Waterwall+Park!5e0!3m2!1sen!2sin!4v1566305861440!5m2!1sen!2sin" data-type="iframe" className="lightbox text-slate-400">1419 Riverwood Drive, <br /> Redding, CA 96001</a>
                                                    </li>

                                                    <li className="flex mt-3">
                                                        <i data-feather="mail" className="h-4 w-4 me-3 mt-1"></i>
                                                        <a href="mailto:contact@example.com" className="text-slate-400">info@cartzio.com</a>
                                                    </li>

                                                    <li className="flex mt-3">
                                                        <i data-feather="phone" className="h-4 w-4 me-3 mt-1"></i>
                                                        <a href="tel:+152534-468-854" className="text-slate-400">(+12) 1546-456-856</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                    ...
                                    <div className="relative overflow-x-auto shadow-sm dark:shadow-gray-800 rounded-md mt-6">
                                        ...
                                        <div className="md:flex justify-between">
                                            <div>
                                                <div className="text-slate-400 text-center md:text-start">
                                                    <h6 className="mb-0">Customer Services : <a href="tel:+152534-468-854" className="text-amber-500">(+12) 1546-456-856</a></h6>
                                                </div>
                                            </div>

                                            <div className="mt-4 md:mt-0">
                                                <div className="text-slate-400 text-center md:text-end">
                                                    <h6 className="mb-0"><a href="page-terms.html" target="_blank" className="text-orange-500">Terms & Conditions</a></h6>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
