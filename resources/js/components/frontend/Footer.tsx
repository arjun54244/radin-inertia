...
export default function Footer() {
    const { infoPages } = usePage<{ infoPages: InfoPage }>().props;
    const explore = [
        { name: "Home", link: "/" },
    ...
    const socialLinks = [
        { name: "Facebook", icon: Facebook, link: infoPages.facebook },
        { name: "Instagram", icon: Instagram, link: infoPages.instagram },
        { name: "LinkedIn", icon: Linkedin, link: infoPages.linkedin },
        { name: "Youtube", icon: Youtube, link: infoPages.youtube },
        { name: "Mail", icon: Mail, link: `mailto:${infoPages.email}` },
    ];
    return (
        <>
            <StickySocialButtons data={infoPages} />
            <footer className="footer bg-slate-900 dark:bg-slate-800 relative text-gray-200 dark:text-gray-200">
                <div className="w-full md:px-24 px-16 relative">
                                ...
                                <div className="grid md:grid-cols-12 grid-cols-1 gap-6">
                                    ...
                                    <div className="lg:col-span-3 md:col-span-4">
                                        ...
                                        <div className="text-slate-400 space-y-4">
                                            {infoPages.addresses.map((address, index) => (
                                                <div className="flex items-start space-x-2" key={index}>
                                                    <MapPin className="w-5 h-5 text-orange-500 mt-1" />
                                                    <div>
                                                        <p className="hover:text-orange-500">{address.street}, {address.state} - {address.city} – {address.postal_code}</p>
                                                    </div>
                                                </div>
                                            ))}
                                            ...
                                            {infoPages.phones.map((phone, index) => (
                                                <div className="flex items-start space-x-2" key={index}>
                                                    ...
                                                    <div>
                                                        ...
                                                        <p >
                                                            <a href={`tel:${phone.number}`} className="hover:text-orange-500">{phone.number}</a>
                                                        </p>
                                                    </div>
                                                </div>
                                            ))}
